...
js.widget.AlertDialog = function(ownerDoc, node) {
	...
	this._button.on("click", this._close, this);
};

js.widget.AlertDialog.prototype = {
	/**
	 * Open system alert. Set message, after formatting if necessary then show the dialog. If message is formatted
	 * optional arguments should respect formatted tags.
	 * <p>
	 * This method also accepts callback and optional scope in which case first optional argument should be a function.
	 * 
	...
	open : function(message) {
		...
		case 2:
		case 3:
			if (js.lang.Types.isFunction(arguments[1])) {
				/**
				 * Callback function.
				 * 
				 * @type Function
				 ...
				 * @type Object
				 */
				this._scope = arguments[2] || window;

				this.setMessage(message);
				break;
			}
			// fall throw next default case

		default:
			this.setMessage($format(arguments));
	...
	/**
	 * Conclude system alert dialog. Hide this dialog and invoke callback, if any.
	 */
	_close : function() {
		this.hide();
...
js.widget.ConfirmDialog = function(ownerDoc, node) {
	 ...
	 * @type js.dom.Element
	 */
	this._okButton = this.getByName("ok");
	 ...
	 * @type js.dom.Element
	 */
	this._cancelButton = this.getByName("cancel");
